      ...
      <section className="pt-32 bg-blue-50 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Left Content */}
            <div>
              <h1 className="text-3xl lg:text-4xl font-extrabold text-blue-500 leading-tight mb-6">
                Master Your TOEFL Score Prepare for iBT & ITP.
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                <span className="font-bold">100+ </span>
                of lessons covering all sections: Reading, Listening, Speaking,
                Writing, and Structure. Learn from TOEFL experts and ace your
                test.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button className="px-8 py-4 border border-blue-500 font-bold text-blue-500 rounded-lg hover:bg-blue-50 transition-colors">
                  How it Works
                </button>
              </div>
              {/* Trust Indicators */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-2xl text-gray-600">
              Our curriculum is focused on the three core pillars of the ITP
              test. Choose your focus to begin.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-[0_10px_25px_rgba(0,0,0,0.06)]">
              <div className="w-12 h-12 rounded-xl bg-purple-100 text-purple-600 flex items-center justify-center shadow-sm mb-6">
                <ThumbsUp className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-extrabold text-gray-900 leading-snug mb-3">
                Structure and
                <br />
                Written Expression
              </h3>
              ...
              <a
                href="#"
                className="group inline-flex items-center text-blue-600 font-semibold hover:text-blue-700 transition-colors"
              >
                Start Learning
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-[0_10px_25px_rgba(0,0,0,0.06)]">
              <div className="w-12 h-12 rounded-xl bg-blue-100 text-blue-600 flex items-center justify-center shadow-sm mb-6">
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-[0_10px_25px_rgba(0,0,0,0.06)]">
              <div className="w-12 h-12 rounded-xl bg-orange-100 text-orange-600 flex items-center justify-center shadow-sm mb-6">
